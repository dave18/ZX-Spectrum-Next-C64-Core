...
ENTITY ps2_keyboard_to_ascii IS
  ...
  PORT(
      ...
      f_out  : OUT STD_LOGIC;                     --output flag indicating new ASCII value
      e_out  : OUT STD_LOGIC;                     --output flag indicating new ASCII value
      ps2_sig_out  : OUT STD_LOGIC;                     --output flag indicating new ASCII value
      ps2_code_out : OUT STD_LOGIC_VECTOR(7 DOWNTO 0)); --PS2 Code value
