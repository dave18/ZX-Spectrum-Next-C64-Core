...
port(
	...
	spec_row    : in  std_logic_vector(7 downto 0);
	spec_col    : in  std_logic_vector(6 downto 0);
	...
	--pa_o        : out unsigned(7 downto 0);
	--matrix_pbi  : in  unsigned(7 downto 0);
...
signal JoyA_n       : unsigned(6 downto 0);
signal JoyB_n       : unsigned(6 downto 0);
...
-- Keyboard
-- -----------------------------------------------------------------------
Keyboard: entity work.kb_matrix_convert
port map (
    clk => clk32,
    reset => kbd_reset,
    spec_col => spec_col,
...
JoyA_n<=not unsigned(joyA(6 downto 0));
JoyB_n<=not unsigned(joyB(6 downto 0));
